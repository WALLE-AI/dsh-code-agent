# bash completion for `dsh --profile tui`.
...
_dsh_tui_complete() {
  ...
  options="--alternate-screen --interactive --no-color --resume --permission --model --diagnostic-log --help"
...
complete -F _dsh_tui_complete dsh
